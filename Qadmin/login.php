	...
	<table border="0" width="790" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0" height="100%">
				...
				<tr><form action="javascript:form()"><td height="68" colspan="2" align="left" valign="top"><a class="tooltip-right" data-tooltip="<?php echo $lng[11]; ?>"><input class="inp" type="email" id="YesIm_Username"></a></td></tr>
				<tr><td height="52" colspan="2" align="left" valign="top"><a class="tooltip-right" data-tooltip="<?php echo $lng[12]; ?>"><input class="inp" type="password" id="YesIm_Password"></a></td></tr>
				<tr><td width="223" align="right" valign="top" id="loading">&nbsp;</td><td align="left" valign="top"><a class="tooltip-right" data-tooltip="<?php echo $lng[13]; ?>"><input type="submit" id="YesIm" value=" " style="width:57; height:27; border:1px solid #FFF; background-color:#FFF; background-image:url('images/login.jpg')"></a></td></tr></form>
			</table></td>
		</tr>
		...
		<tr><td width="790" colspan="2" align="center">
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td align="center" width="730"><font face="Arial" size="1"><?php echo $lng[14]; ?></font></td>
					<td width="30" rowspan="3">&nbsp;</td>
				</tr>
