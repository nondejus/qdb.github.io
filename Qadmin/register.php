	...
	<table border="0" width="790" cellspacing="0" cellpadding="0">
		...
		<tr><td width="330" valign="top" background="images/Q.box.line.jpg"><img border="0" src="images/Q.box.logo.png"><img border="0" src="images/Q.box.left.jpg" width="330" height="60"></td>
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0" height="100%">
				...
				<tr><form action="javascript:form()"><td height="68" colspan="2" align="left" valign="top"><a class="tooltip-right" data-tooltip="<?=$lng[12]?>"><input class="inp" type="email" id="email"></a></td></tr>
				<tr><td height="68" colspan="2" align="left" valign="top"><a class="tooltip-right" data-tooltip="<?=$lng[13]?>"><input class="inp" type="password" id="password"></a></td></tr>
				<tr><td height="52" colspan="2" align="left" valign="top"><a class="tooltip-right" data-tooltip="<?=$lng[14]?>"><input class="inp" type="password" id="confpsw"></a></td></tr>
				<tr><td width="197" align="right" valign="top" id="loading">&nbsp;</td><td align="left" valign="top"><a class="tooltip-right" data-tooltip="<?=$lng[15]?>"><input type="submit" value=" " style="width:81; height:27; border:1px solid #FFF; background-color:#FFF; background-image:url('images/register.jpg')"></a></td>
                </tr></form>
			</table></td>
		</tr>
		<tr><td id="tb5" width="790" colspan="2"><table border="0" width="790" cellspacing="0" cellpadding="0" background="images/Q.box.line.jpg" height="20"><tr><td width="790" height="20" align="right"><h6><?=$lng[16]?>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&ensp;</h6></td></tr></table></td></tr>
		...
		<tr><td width="790" colspan="2" align="center">
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td align="center" width="730"><font face="Arial" size="1"><?=$lng[17]?></font></td>
					<td width="30" rowspan="3">&nbsp;</td>
				</tr>
			</table>
		</td></tr>
