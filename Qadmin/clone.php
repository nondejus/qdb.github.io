...
<?php
    ...
    elseif($_GET['type'] == 2) { // ----------------------------------------- inizio clonazione
        ...
        if($Qclonatot) { $Qclonatot++; $cnf = file('../Quantico.php'); $cnf[2] = str_replace('/Qconfig.php\');','/Qconfig.php\'); $Qdatabase .= \'-clone\';',$cnf[2]); $dbtype[3] = "clone\n";
            copy('schema/command.php','schema/clone/command.php'); copy('schema/note.php','schema/clone/note.php'); copy('schema/key.php','schema/clone/key.php'); for($a=1; $a<8; $a++) copy("schema/$a.php","schema/clone/$a.php"); 
            file_put_contents($Qdatabase.'-clone/clone.php',$Qprotezione.$inizio."\n".$fine."\n"); file_put_contents('../Quantico.clone.php',$cnf); file_put_contents('config.php',$dbtype);
            echo "<span style='position:absolute; left:0; top:100px; z-index:$Qclonatot; background:#FFF; color:red; font-size:128px'><font size='6'><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$lng[12]."<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$lng[13]."</b></font><font size='4' color='blue'><br><br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<u>".$lng[14]."</u></font></span>";
        } else {
            echo "<span style='position:absolute; left:0; top:100px; z-index:$Qclonatot; background:#FFF; color:red; font-size:128px'><font size='6'><b>&nbsp;&nbsp;&nbsp;&nbsp;".$lng[15]."</b></font><font size='4' color='blue'><br><br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<u>".$lng[14]."</u></font></span>";
        } exit;
    }
