<?php
    ...
    if(isset($_POST['val'])) $val = json_decode($_POST['val']);
    
    if(strpos($val, '"') !== false && strpos($val, "'") !== false) exit('<h1>-:|:- Prohibited -:|:-</h1>');
