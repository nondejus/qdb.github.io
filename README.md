## What is QuanticoDB ?
QuanticoDB is a fast, simple ( 4 command ), 100% Fully Encrypted NOSQL database + Artificial Intelligence ( Auto Training ) who can talk and learn from IBM Watson, Microsoft Cognitive, Google Prediction with just one simple language.
